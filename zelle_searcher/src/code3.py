...
class MoveBaseSeq():
    ...
    def __init__(self):
        ...
        rospy.loginfo("Starting goals chase ...")
    ...
    def movebase_SkipPreviousGoal(self):
        print("Location pose " + str(self.g_add) + " is in process.")
        rospy.sleep(2)
        if self.g_add < len(self.goallist):
            ...
            rospy.loginfo("Final location pose reached!")
            rospy.signal_shutdown("Final location pose reached!")
